  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        short_name: "Mantarie",
        name: "Mantarie",
        description: "Mantarie is a numerical methods tool built using React. It allows users to determine the value of a definite integral using two methods; Trapezoidal & Simpson's.",
        display: "standalone",
        scope: "/",
        start_url: "/",
        icons: [
